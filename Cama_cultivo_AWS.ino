...
const char* AWS_HUERTO_URL = "http://TU_IP_AWS_AQUI/huerto";
const char* DEVICE_SECRET = "TU_DEVICE_SECRET_AQUI";
...
const char* WIFI_PASSWORD = "TU_WIFI_PASSWORD_AQUI";
...
const char* AP_PASSWORD = "TU_AP_PASSWORD";
